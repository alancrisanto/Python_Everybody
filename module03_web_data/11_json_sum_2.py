...
You can test to see if your program is working with a location of "University of Colorado at Boulder" which will have a place_id of "ChIJwR6cajTsa4cR2TH0qKTVKAM".

$ python3 solution.py
Enter location: University of Colorado at Boulder
Retrieving http://...
Retrieved 2259 characters
Place id ChIJwR6cajTsa4cR2TH0qKTVKAM
Turn In
...
while True:
    # Enter the name of the location like: University of Colorado at Boulder
    # test location for this asignment: Fachhochschule Dusseldorf
